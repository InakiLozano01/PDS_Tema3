...
def process_signals():
    global a_signal, e_signal, i_signal, processed_a, processed_e, processed_i, multiplexed, fs_multiplexed, demux_a, demux_e, demux_i
...
def plot_signals():
    ...
    plot_spectrum_and_time(processed_a, 8000, 'Señal acondicionada "a"')
    plot_spectrum_and_time(e_signal, fs, 'Señal original "e"')
    plot_spectrum_and_time(processed_e, 8000, 'Señal acondicionada "e"')
    plot_spectrum_and_time(i_signal, fs, 'Señal original "i"')
    plot_spectrum_and_time(processed_i, 8000, 'Señal acondicionada "i"')
    plot_spectrum_and_time(multiplexed, fs_multiplexed, 'Señal multiplexada')
    plot_spectrum_and_time(demux_a, 8000, 'Señal demultiplexada "a"')
    plot_spectrum_and_time(demux_e, 8000, 'Señal demultiplexada "e"')
    plot_spectrum_and_time(demux_i, 8000, 'Señal demultiplexada "i"')

def save_plots():
    global a_signal, e_signal, i_signal, processed_a, processed_e, processed_i
    global multiplexed, demux_a, demux_e, demux_i

    plot_spectrum_and_time(a_signal, fs, 'Señal original "a"', save=True, filename='original_a.png')
    plot_spectrum_and_time(processed_a, 8000, 'Señal acondicionada "a"', save=True, filename='processed_a.png')
    plot_spectrum_and_time(e_signal, fs, 'Señal original "e"', save=True, filename='original_e.png')
    plot_spectrum_and_time(processed_e, 8000, 'Señal acondicionada "e"', save=True, filename='processed_e.png')
    plot_spectrum_and_time(i_signal, fs, 'Señal original "i"', save=True, filename='original_i.png')
    plot_spectrum_and_time(processed_i, 8000, 'Señal acondicionada "i"', save=True, filename='processed_i.png')
    plot_spectrum_and_time(multiplexed, fs_multiplexed, 'Señal multiplexada', save=True, filename='multiplexed.png')
    plot_spectrum_and_time(demux_a, 8000, 'Señal demultiplexada "a"', save=True, filename='demux_a.png')
    plot_spectrum_and_time(demux_e, 8000, 'Señal demultiplexada "e"', save=True, filename='demux_e.png')
    plot_spectrum_and_time(demux_i, 8000, 'Señal demultiplexada "i"', save=True, filename='demux_i.png')
...
def process_audio(queue, fs, new_fs):
    while real_time_processing:
        if not queue.empty():
            ...
            filtered_audio = notch_filter(filtered_audio, fs, f0=2800, Q=30.0)
...
class AudioPlayerGUI:
    ...
    def create_widgets(self):
        ...
        self.plot_button = ttk.Button(frame, text="Plot Signals", command=plot_signals, style="TButton")
        self.plot_button.pack(pady=5)

        self.save_plots_button = ttk.Button(frame, text="Save Plots", command=save_plots, style="TButton")
